...
const ProjectsSection = () => {
  ...
  return <section id="projects" className="section bg-background py-24">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col space-y-8">
          {projects.map((project, index) => <Card key={project.id} className="overflow-hidden border-none shadow-lg dark-card animate-on-scroll" style={{
                ...
                <div className="lg:w-1/2 p-6 lg:p-10 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.tags.map((tag, i) => <span key={i} className="text-xs px-3 py-1 bg-accent/10 text-accent rounded-full">
                          {tag}
                        </span>)}
                    </div>
                  </div>
